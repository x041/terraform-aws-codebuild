...
| [aws_codebuild_webhook.default](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/codebuild_webhook) | resource |
...
| [aws_iam_role.build_batch](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role.default](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role_policy.build_batch](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
...
| [aws_iam_policy_document.build_batch](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_build_batch_config"></a> [build\_batch\_config](#input\_build\_batch\_config) | n/a | <pre>object(<br/>    {<br/>      enabled                  = optional(bool, false)<br/>      combine_artifacts        = optional(bool, false)<br/>      iam_role_path            = optional(string, null)<br/>      iam_permissions_boundary = optional(string, null)<br/>      restrictions = object(<br/>        {<br/>          compute_types_allowed  = optional(list(string), ["BUILD_GENERAL1_SMALL"])<br/>          maximum_builds_allowed = optional(number, 1)<br/>        }<br/>      )<br/>      timeout_in_mins = optional(number, 20)<br/>    }<br/>  )</pre> | <pre>{<br/>  "restrictions": {}<br/>}</pre> | no |
...
| <a name="input_secondary_artifacts"></a> [secondary\_artifacts](#input\_secondary\_artifacts) | (Optional) S3 secondary artifacts destination for the codebuild project in addition to the primary artifact. Key is artifact identifier. See: https://docs.aws.amazon.com/codebuild/latest/APIReference/API_ProjectArtifacts.html | <pre>map(object(<br/>    {<br/>      bucket_location    = string<br/>      encryption_enabled = optional(bool, false)<br/>      # According to AWS documention, in order to have the artifacts written<br/>      # to the root of the bucket, the 'namespace_type' should be 'NONE'<br/>      # (which is the default), 'name' should be '/', and 'path' should be<br/>      # empty. For reference, see https://docs.aws.amazon.com/codebuild/latest/APIReference/API_ProjectArtifacts.html.<br/>      # However, I was unable to get this to deploy to the root of the bucket<br/>      # unless path was also set to '/'.<br/>      path = optional(string, "/")<br/>      name = optional(string, "/")<br/>  }))</pre> | `{}` | no |
...
| <a name="input_webhook"></a> [webhook](#input\_webhook) | Webhook configuration for the codebuild project | <pre>object({<br/>    enabled = optional(bool, false)<br/>    filter_groups = optional(list(object({<br/>      filters = optional(list(object({<br/>        pattern = string<br/>        type    = string<br/>        exclude = optional(bool, false)<br/>      })), [])<br/>    })), [])<br/>  })</pre> | `{}` | no |
